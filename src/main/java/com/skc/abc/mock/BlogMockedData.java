...
public class BlogMockedData {
	...
	/*
	 * the static method checks if the class is already instantiated and return the
	 * existing instance, otherwise it creates a new instance of that class and
	 * returns it
	 * 
	 * So, when we need an instance of BlogMockedData, we instantiate it like this:
